...
public class CreateWhatsAppTemplateRequest {
    ...
    @NotNull(message = "Sender scope is required.")
    @Schema(description = "Which Twilio account the Content SID lives under: the application default or the organization's own",
            example = "DEFAULT")
