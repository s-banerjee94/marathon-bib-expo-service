package com.timekeeper.bibexpo.participant.model.dynamodb;
...
public class ParticipantDDB {
    ...
    public static final String CHIP_NUMBER_INDEX = "LSI-ChipNumberIndex";
    public static final String FULL_NAME_INDEX = "LSI-FullNameIndex";
    public static final String EMAIL_INDEX = "LSI-EmailIndex";
    public static final String PHONE_NUMBER_INDEX = "LSI-PhoneNumberIndex";
    public static final String RACE_CATEGORY_INDEX = "LSI-RaceCategoryIndex";
    ...
    @Getter(onMethod_ = @DynamoDbSecondarySortKey(indexNames = CHIP_NUMBER_INDEX))
    private String chipNumber;

    @Getter(onMethod_ = @DynamoDbSecondarySortKey(indexNames = FULL_NAME_INDEX))
    private String fullName;

    @Getter(onMethod_ = @DynamoDbSecondarySortKey(indexNames = EMAIL_INDEX))
    private String email;

    @Getter(onMethod_ = @DynamoDbSecondarySortKey(indexNames = PHONE_NUMBER_INDEX))
    ...
    @Getter(onMethod_ = @DynamoDbSecondarySortKey(indexNames = RACE_CATEGORY_INDEX))
