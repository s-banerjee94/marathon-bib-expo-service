package com.timekeeper.bibexpo.storage.service;
...
public interface StorageService {
     ...
     * @throws com.timekeeper.bibexpo.storage.exception.InvalidFileException if the content type is not allowed for the category
     */
