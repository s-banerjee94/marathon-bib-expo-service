...
@AllArgsConstructor
@Builder
@Schema(description = "Request payload for updating a WhatsApp template; absent fields are left unchanged")
public class UpdateWhatsAppTemplateRequest {
    ...
    @Schema(description = "Which Twilio account the Content SID lives under", example = "ORGANIZATION")
