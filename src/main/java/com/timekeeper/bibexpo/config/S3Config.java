...
/**
 * S3 client and presigner wiring. Mirrors {@link DynamoDBConfig}: when an endpoint
 * override is set (LocalStack) it uses static credentials and path-style access;
 * otherwise it targets real AWS S3 via the default credentials provider (EC2 instance role).
 */
@Configuration
